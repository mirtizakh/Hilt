...
constructor(
    ...
    private fun displayProgressBar(isDisplayed: Boolean){
        requireView().findViewById<View>(R.id.progress_bar).visibility = if(isDisplayed) View.VISIBLE else View.GONE
    }
}